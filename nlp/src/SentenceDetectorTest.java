	...
	public static void main(String[] args) throws IOException {
		...
		ObjectStream<String> lineStream = new PlainTextByLineStream(new InputStreamFactory() {
			public InputStream createInputStream() throws IOException {
				return new FileInputStream(Constants.BASE_PATH + "train/en-sent2.train");
			}
		}, charset);
		...
		OutputStream modelOut = null; try { modelOut = new BufferedOutputStream(new FileOutputStream(Constants.BASE_PATH + "train/en-sent2.bin")); model.serialize(modelOut); } finally { if (modelOut != null) modelOut.close(); } 
