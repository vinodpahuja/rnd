...
public class XMLParserException extends JCommonException
  {
    private static final long serialVersionUID = 100L;
    
    public XMLParserException(Throwable cause) { super(cause); }
    public XMLParserException(String message) { super(message); }
    public XMLParserException(String message, Throwable cause) { super(message,cause); }
  }
