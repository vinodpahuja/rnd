...
public class SimpleExample
  {
    public SimpleExample(DatabaseManager dbm) throws JPersistException
      {
        // Clean out contacts
...
//            dbm = DatabaseManager.getXmlDefinedDatabaseManager("jpersist");
            dbm = DatabaseManager.getUrlDefinedDatabaseManager("testdb", 10, "org.hsqldb.jdbcDriver", "jdbc:hsqldb:file:/home/vinodp/Data/lib/Perisistence/testdb","","");

            new SimpleExample(dbm);
          }
        finally
          {
