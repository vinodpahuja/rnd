...
public class RecEngine {
	...
	public static void main(String[] args) {
		...
		// Create user-item tuples for the items that are not rated by user, with user id 0
		JavaRDD<Tuple2<Object, Object>> itemsNotRatedByUser = notRatedByUser.map(new Function<Integer, Tuple2<Object, Object>>() {
